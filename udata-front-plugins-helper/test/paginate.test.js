...
import {getVisiblePages, PAGES_AROUND} from "../src/index";
...
describe('paginate', function () {
  ...
  it('adds null if page 2 is not in array', function () {
  ...
  it('adds null if the second last page is not in array', function () {
  ...
  it('never contains pages greater than the last one', function () {
    const pagination = getVisiblePages(PAGE_COUNT_WITH_ELLIPSIS_ON_ONE_SIDE, PAGE_COUNT_WITH_ELLIPSIS_ON_ONE_SIDE);
