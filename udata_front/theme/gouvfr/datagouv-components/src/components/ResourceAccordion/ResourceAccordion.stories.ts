...
const argsWithSchema = {
  ...
  resource: {
    ...
    created_at: "2023-11-15T10:40:22.288000+00:00",
    description: ``,
    extras: {"check:available": true, "check:date": "2023-11-15T10:40:27.222278+00:00", "check:headers:content-type": "text/csv", "check:status": 200, "check:timeout": false, "publish_source": "publier.etalab.studio", "analysis:parsing:parquet_file": "https://example.org/file.parquet"},
    filesize: 9167,
    filetype: "file",
    format: "csv",
    harvest: null,
