...
const newResourceAdminUrl = new URL(config.admin_root?.startsWith('http') ? config.admin_root : `${document.location.origin}${config.admin_root}` + "community-resource/new/");
