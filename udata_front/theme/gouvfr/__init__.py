...
opendata_links.append(nav.Item(_('Follow data opening'), None, url="https://ouverture.data.gouv.fr"))
...
platform_links = [
    ...
    nav.Item(_('Contact us'), None, url='https://support.data.gouv.fr'),
    nav.Item(_('Give us your feedback'), None, url=current_app.config.get('FEEDBACK_FORM_URL', '#')),
]
...
resources_links = [
    ...
    nav.Item(_("Data schema referential"), None, url=current_app.config.get('SCHEMA_DOCUMENTATION_URL', '#')),
