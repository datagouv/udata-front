...
@blueprint.route('/admin/organizations/<organization_id>/dataservices/<dataservice_id>', endpoint='beta-admin-org-dataservice')
class AdminViewDataservice(LoginOnlyView):
    template_name = 'beta/admin.html'
